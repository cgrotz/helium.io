 ...
 * DataSnapshot but is available for use within Security Rule Expressions.</p>
 * 
 * <p>The data, newData, and root variables each return a RulesDataSnapshot,
...
public interface RulesDataSnapshot {
	...
	/**
	 * Get the priority of the data in this RulesDataSnapshot.
	 */
