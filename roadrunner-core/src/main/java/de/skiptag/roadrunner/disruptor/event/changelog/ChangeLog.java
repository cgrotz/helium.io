...
public class ChangeLog {
    ...
    public void addChildAddedLogEntry(String name, Path path, Path parent,
	    Object value, boolean hasChildren, long numChildren,
	    String prevChildName, int priority) {
	log.add(new ChildAddedLogEvent(name, path, parent, value, numChildren,
		prevChildName, priority));
    }

    public void addChildChangedLogEntry(String name, Path path, Path parent,
	    Object value, boolean hasChildren, long numChildren,
	    String prevChildName, int priority) {
	log.add(new ChildChangedLogEvent(name, path, parent, value,
		numChildren, prevChildName, priority));
    }

    public void addValueChangedLogEntry(String name, Path path, Path parent,
