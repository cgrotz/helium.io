...
public class HeliumWebSocketServlet extends WebSocketServlet {
     ...
     *
     * @param origin The value of the origin header from the request which may be <code>null</code>
     ...
     *
     * @param subProtocols The list of sub-protocols supported by the client in client preference order. The
