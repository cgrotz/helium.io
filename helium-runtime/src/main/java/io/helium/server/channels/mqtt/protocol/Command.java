package io.helium.server.channels.mqtt.protocol;
...
public class Command {
    ...
    public Command(CommandType commandType, boolean dupFlag, QosLevel qosLevel, boolean retainFlag, long remainingLength) {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("commandType", commandType).add("dupFlag", dupFlag).add("qosLevel", qosLevel).add("retainFlag", retainFlag).add("remainingLength", remainingLength).toString();
    }
}
