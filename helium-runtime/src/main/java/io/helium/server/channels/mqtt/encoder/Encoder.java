package io.helium.server.channels.mqtt.encoder;

import io.helium.server.channels.mqtt.protocol.ConnackCode;
...
public class Encoder {
    ...
    public void encodePublish(ByteBuf out, int messageId, String topic, String payload) throws UnsupportedEncodingException {
        ...
        publishEncoder.encode(publishMessage, out);
        //
        // --------+-----+-----+-----+-----+-----+-----+-----+------+
        // bit     |  7  |  6  |  5  |  4  |  3  |  2  |  1  |  0   |
        // --------+-----+-----+-----+-----+-----+-----+-----+------+
